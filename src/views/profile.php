...
<div class="profile-edit-modal" id="profileEditModal" aria-hidden="true">
    ...
    <div class="profile-edit-card">
        <form id="profileEditForm" method="POST" action="index.php?page=profile" enctype="multipart/form-data">
            ...
            <input type="hidden" name="selected_avatar" id="selectedAvatarInput" value="">
                    ...
                    <div class="avatar-picker">
                        ...
                        <div class="avatar-options">
                            ...
                            <div class="avatar-option-block">
                                ...
                                <label class="btn btn-outline btn-small" for="avatarUpload">
                                    Choose File
                                </label>
                                <input type="file" id="avatarUpload" name="avatar_file" accept="image/*" style="display:none;">
                                <p class="tool-hint" id="selectedFileName" style="margin-top: 8px; font-size: 12px; color: #666;"></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <p class="tool-hint">Click "Save Changes" to update your profile picture and bio.</p>
        </form>
    </div>
</div>
<?php endif; ?>
