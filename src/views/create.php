            ...
            <div class="tab-panel active" data-panel="stickers">
                ...
                <div class="picker-grid" id="stickerList">
                    <?php $stickers = [
                        ...
                        ['file' => 'sticker12.svg', 'label' => 'Bright', 'category' => 'fun'],
                        ['file' => 'sticker14.svg', 'label' => 'Old School', 'category' => 'retro'],
                        ['file' => 'sticker17.svg', 'label' => 'Throwback', 'category' => 'retro'],
                        ['file' => 'sticker18.svg', 'label' => 'Epic', 'category' => 'fun'],
                        ['file' => 'Untitled Project (1).png', 'label' => 'Cat 1', 'category' => 'fun'],
                        ['file' => 'Untitled Project (2).png', 'label' => 'Cat 2', 'category' => 'retro'],
                        ['file' => 'Untitled Project (3).png', 'label' => 'Cig 1', 'category' => 'fun'],
                        ['file' => 'Untitled Project (4).png', 'label' => 'Cig 2', 'category' => 'fun'],
                        ['file' => 'Untitled Project (5).png', 'label' => 'Smoke', 'category' => 'retro'],
                        ['file' => 'Untitled Project (6).png', 'label' => 'Hat 1', 'category' => 'fun'],
                        ['file' => 'Untitled Project (7).png', 'label' => 'Hat 2', 'category' => 'fun'],
                        ['file' => 'Untitled Project (8).png', 'label' => 'Hat 3', 'category' => 'retro'],
                        ['file' => 'Untitled Project (9).png', 'label' => 'Hat 4', 'category' => 'fun'],
                        ['file' => 'Untitled Project (10).png', 'label' => 'Dog 1', 'category' => 'fun'],
                        ['file' => 'Untitled Project (11).png', 'label' => 'Dog 2', 'category' => 'retro']
                ...
                <div class="emoji-actions__buttons">
                    <p class="tool-hint">Click sticker to place. Drag to move, Shift+Drag to resize, Ctrl+Drag to rotate.</p>
